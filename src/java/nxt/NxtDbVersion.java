...
class NxtDbVersion extends DbVersion {
    ...
    protected void update(int nextUpdate) throws SQLException {
        switch (nextUpdate) {
            ...
            case 37:
                if (!Constants.isTestnet) {
                    apply("INSERT INTO peer (address) VALUES " +
                            "('142.93.176.83'), ('68.183.177.7'), ('178.128.254.195'), ('209.97.177.48'), ('167.99.136.204'), ('192.169.235.154'), ('72.167.184.196')");
                } 
            case 38:
            ...
            case 231:
                apply("CREATE TABLE IF NOT EXISTS contact (address VARCHAR PRIMARY KEY, nickname VARCHAR NOT NULL, email VARCHAR, description VARCHAR)");
            case 232:
                apply("CREATE TABLE IF NOT EXISTS setting (settingKey VARCHAR PRIMARY KEY, settingValue VARCHAR)");
            case 233:
                return;
            default:
