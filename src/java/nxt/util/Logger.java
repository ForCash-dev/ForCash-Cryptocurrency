...
public final class Logger {
    ...
    static {
        ...
        if (! Boolean.getBoolean("fch.doNotConfigureLogging")) {
            try {
        ...
        enableStackTraces = Nxt.getBooleanProperty("fch.enableStackTraces");
        enableLogTraceback = Nxt.getBooleanProperty("fch.enableLogTraceback");
