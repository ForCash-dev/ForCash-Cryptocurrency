    ...
    public static final TransactionType RESERVE_INCREASE = new MonetarySystem() {
        ...
        void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
            ...
            if (attachment.getAmountPerUnitNQT() <= 0) {
                throw new NxtException.NotValidException("Reserve increase FCH amount must be positive: " + attachment.getAmountPerUnitNQT());
            }
    ...
    public static final TransactionType CURRENCY_MINTING = new MonetarySystem() {
        ...
        void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
            ...
            if (attachment.getCounter() <= counter) {
                String debug = CurrencyMint.debug(attachment.getCurrencyId(), transaction.getSenderId());
                throw new NxtException.NotCurrentlyValidException(String.format(debug + "\nCounter %d has to be bigger than %d \ntransaction %s", attachment.getCounter(), counter,
