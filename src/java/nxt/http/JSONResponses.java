...
public final class JSONResponses {
    ...
    public static final JSONStreamAware INCORRECT_DIRECTION = incorrect("direction");
    ...
    public static final JSONStreamAware MISSING_KEY = missing("key");
    public static final JSONStreamAware MISSING_VALUE = missing("value");
    public static final JSONStreamAware MISSING_ADDRESS = missing("address");
    ...
    public static final JSONStreamAware MISSING_NONE = missing("nickname and address, set one");
    public static final JSONStreamAware MISSING_BOTH = missing("set nickname and address, set only one");
