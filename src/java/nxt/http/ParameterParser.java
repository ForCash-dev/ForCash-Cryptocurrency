...
final class ParameterParser {
    ...
    static TransactionDirection getDirection(HttpServletRequest req) throws ParameterException {
        String directionValue = Convert.emptyToNull(req.getParameter("direction"));
        if (directionValue == null) {
            return TransactionDirection.BOTH;
        }
        ...
        throw new ParameterException(INCORRECT_DIRECTION);
    }
