...
public final class APIServlet extends HttpServlet {
    ...
    private static final boolean enforcePost = Nxt.getBooleanProperty("fch.apiServerEnforcePOST");
    ...
    static {
        ...
        map.put("saveContact", SaveContact.instance);
        map.put("getContact", GetContact.instance);
        map.put("getContacts", GetContacts.instance);
        map.put("deleteContact", DeleteContact.instance);
        map.put("updateContact", UpdateContact.instance);
        map.put("getSetting", GetSetting.instance);
        map.put("getSettings", GetSettings.instance);
        map.put("updateSettings", UpdateSettings.instance);
        map.put("updateClient", UpdateClient.instance);
