...
public final class Account {
    ...
    public long getEffectiveBalanceNXT() {
        ...
        if (this.creationHeight == 0 && lastBlock.getHeight()< Constants.GENESIS_FORGING_BLOCK) {
            //Logger.logDebugMessage("Efektivni zustatek" + Constants.MAX_BALANCE_NXT / Constants.ONE_NXT);
