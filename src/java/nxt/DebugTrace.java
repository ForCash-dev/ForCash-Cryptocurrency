...
public final class DebugTrace {
    ...
    static final String QUOTE = Nxt.getStringProperty("fch.debugTraceQuote", "");
    static final String SEPARATOR = Nxt.getStringProperty("fch.debugTraceSeparator", "\t");
    static final boolean LOG_UNCONFIRMED = Nxt.getBooleanProperty("fch.debugLogUnconfirmed");

    static void init() {
        List<String> accountIdStrings = Nxt.getStringListProperty("fch.debugTraceAccounts");
        String logName = Nxt.getStringProperty("fch.debugTraceLog");
