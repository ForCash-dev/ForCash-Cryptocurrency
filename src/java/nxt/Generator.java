...
public final class Generator implements Comparable<Generator> {
    ...
    static {
        byte[] publicKey = null;
        if (Nxt.getBooleanProperty("fch.enableFakeForging")) {
            Account fakeForgingAccount = Account.getAccount(Convert.parseAccountId(Nxt.getStringProperty("fch.fakeForgingAccount")));
